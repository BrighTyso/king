...
if (isset($data->userid)) {
    ...
    $sql = "Select distinct grower_num,bale_junus.transporter_growersid,splitid,lot,bale_group,barcode,price,buyer_grades.description as buyer_grade , timb_grades.description as timb_grade,mass,sale_code,exchange_rate.amount as exchange_rate_amount,exchange_rate.id as exchange_rateid from bale_junus join growers on growers.id=bale_junus.growerid join tickets on tickets.bale_junusid=bale_junus.id 
    ...
    if ($number_of_bales>0 && $split_bales==$number_of_bales) {
